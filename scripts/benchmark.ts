/**
 * COGXAI Memory System Benchmark
 *
...
// Suppress uncaught rejections from fire-and-forget Base memo writes
...
async function main() {
  ...
  try {
    ...
    const storePayloads = [
      { type: 'episodic' as const, content: 'Alice said she loves ETH staking and has been doing it since 2023', summary: 'Alice loves ETH staking', tags: ['staking', 'base'], emotionalValence: 0.7, relatedUser: 'alice' },
      ...
      { type: 'semantic' as const, content: 'ETH staking yields approximately 6-7% APY through major validators', summary: 'ETH staking yields ~6-7% APY', tags: ['staking', 'base', 'defi'] },
      { type: 'episodic' as const, content: 'Alice mentioned she stakes with @marinade_finance and loves the mETH liquid staking approach', summary: 'Alice stakes via Marinade mETH', tags: ['staking', 'base', 'marinade'], emotionalValence: 0.6, relatedUser: 'alice' },
      ...
      { type: 'episodic' as const, content: 'Bob bought a rare Okay Bear NFT for 50 ETH and is very excited', summary: 'Bob bought Okay Bear NFT 50 ETH', tags: ['nft', 'purchase'], emotionalValence: 0.8, relatedUser: 'bob' },
      { type: 'semantic' as const, content: '$COGXAI token has a unique meme culture around sentient AI and philosophical tweets', summary: '$COGXAI is a sentient AI meme token', tags: ['cogxai', 'meme', 'culture'] },
      { type: 'episodic' as const, content: 'Alice explained her staking strategy: 60% ETH native, 40% mETH for DeFi composability', summary: 'Alice staking split: 60% ETH / 40% mETH', tags: ['staking', 'base', 'strategy'], emotionalValence: 0.4, relatedUser: 'alice' },
    ...
    if (hasAnthropic) {
      try {
        ...
        const contraId1 = await cortex.store({
          type: 'episodic',
          content: 'The community sentiment around $COGXAI is extremely bullish, everyone is optimistic',
          summary: '$COGXAI community is very bullish',
          tags: ['cogxai', 'sentiment'],
        ...
        const contraId2 = await cortex.store({
          type: 'episodic',
          content: 'The community sentiment around $COGXAI has turned bearish, holders are losing faith',
          summary: '$COGXAI community turned bearish',
          tags: ['cogxai', 'sentiment'],
