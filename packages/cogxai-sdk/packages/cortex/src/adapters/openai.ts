...
//
// Wraps @cogxai/brain as OpenAI-compatible tools.
...
//   const result = await handleCogxAITool(toolCall, engine)
// ============================================================

/** OpenAI function definitions for CogxAI memory operations. */
export const cogxaiTools = [
  {
    type: 'function' as const,
    function: {
      name: 'cogxai_remember',
...
/**
 * Handle a CogxAI tool call from OpenAI's function calling.
 * Pass the engine from @cogxai/brain or @cogxai/local.
 */
export async function handleCogxAITool(
