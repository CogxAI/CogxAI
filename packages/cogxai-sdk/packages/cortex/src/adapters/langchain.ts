...
//
// Wraps @cogxai/brain as a LangChain-compatible memory class.
//
...
/**
 * LangChain-compatible memory wrapper for CogxAI.
 * Implements the BaseMemory interface pattern.
 */
export class CogxAIMemory {
  private engine: {
  ...
  async clear(): Promise<void> {
    // CogxAI doesn't support mass deletion through the engine
 ...
 */
export class CogxAICheckpointer {
  private engine: {
    store: (opts: any) => Promise<any>;
    recall: (opts: any) => Promise<any[]>;
  };
