...
export function memoryToMarkdown(memory: Memory): string {
  ...
  if (memory.base_signature) {
    meta.push(`**On-chain:** [${memory.base_signature.slice(0, 12)}...](https://basescan.org/tx/${memory.base_signature})`);
  }
...
export function packToMarkdown(pack: MemoryPack): string {
  ...
  lines.push('---');
  lines.push(`*Exported from [CogxAI](https://cogxai.org) memory system*`);
