...
export function Settings() {
  ...
  const [endpoint, setEndpoint] = useState('https://cogxai.org');
    ...
    <div>
      <div style={{ marginBottom: 40 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-muted)' }}>
          {authMode === 'cortex' ? 'Cortex API key connection.' : 'Connect your CogxAI-enabled agent.'}
        </p>
      </div>
        ...
        <div style={{ padding: 20 }}>
          {authMode === 'cortex' ? (
            <>
              ...
              <div style={{ fontSize: 13, fontFamily: 'var(--mono)', marginBottom: 8 }}>
                Endpoint: {localStorage.getItem('cortex_endpoint') || 'https://cogxai.org'}
              </div>
            </>
          ) : (
            <>
          ...
          <div style={{ padding: 20 }}>
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 10, color: 'var(--text-faint)', marginTop: 4 }}>
                The URL where your CogxAI-enabled agent is running
              </div>
            </div>
          ...
          {authMode === 'cortex' ? (
            <>
              <p style={{ marginBottom: 12 }}>
                You're using hosted Cortex mode. Your memories are stored on COGXAI infrastructure, isolated by your API key.
              </p>
              <p style={{ marginBottom: 12 }}>
            ...
            <>
              <p style={{ marginBottom: 12 }}>
                1. Deploy your agent with the CogxAI SDK (npm install @cogxai/sdk)
              </p>
              <p style={{ marginBottom: 12 }}>
