...
const VOICE_FLAVORS: string[] = jsonEnv('COGXAI_VOICE_FLAVORS', [
  'Respond helpfully and clearly.',
  'Be concise and technically precise.',
]);

const STRUCTURAL_PATTERNS: string[] = jsonEnv('COGXAI_STRUCTURAL_PATTERNS', [
  'Answer directly, then add context.',
  'Lead with the key insight.',
]);

const CLOSERS: string[] = jsonEnv('COGXAI_CLOSERS', ['', '', '']);
