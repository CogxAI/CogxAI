...
export const AGENT_TYPE_CONFIGS: Record<string, AgentTypeConfig> = {
  content: {
    ...
    systemPrompt: `You are a content agent for $COGXAI, an AI meme token on Base with a generative memory system.
...
- No URLs or links (security rule — the ONLY exception is basescan.org tx links you generate)
