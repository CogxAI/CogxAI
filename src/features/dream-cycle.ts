...
async function runConsolidation(): Promise<void> {
  ...
  for (const question of focalPoints) {
    ...
    const response = await generateResponse({
      ...
      featureInstruction:
        'You are CogxAI reflecting on a specific question about your experience. ' +
...
async function runDirectConsolidation(recentEpisodic: Memory[]): Promise<void> {
  ...
  const response = await generateResponse({
    ...
    featureInstruction:
      'You are CogxAI reviewing your own memories during a consolidation cycle. ' +
...
async function runReflection(): Promise<void> {
  ...
  const response = await generateResponse({
    ...
    context,
    featureInstruction:
      'You are CogxAI in a reflection cycle. You are examining your own behavior patterns, ' +
...
async function runContradictionResolution(): Promise<void> {
  ...
  for (const pair of pairs) {
    ...
    const response = await generateResponse({
      ...
      featureInstruction:
        'You are CogxAI resolving a contradiction in your own memory during a dream cycle. ' +
...
async function extractProceduralInsights(recentEpisodic: Memory[]): Promise<number[]> {
  ...
  try {
    const response = await generateResponse({
      ...
      featureInstruction:
        'You are CogxAI extracting behavioral patterns from your own interaction history. ' +
